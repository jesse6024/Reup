...
<body style="width: 100%;">
    ...
    <nav class="navbar navbar-default" style="background-color: #ffffff; border-color: #ffffff;">
      <div class="container-fluid">
        <div class="navbar-header" style="font-size:20px; margin-top:20px;">
          <a class="navbar-brand" href="homepage.php">REUP MARKET</a>
        </div>
        <ul class="nav navbar-nav">
        <div class="dropdown">
  <button class="dropbtn">Home</button></div>
        <div class="dropdown">
...
<div class="dropdown">
  <button class="dropbtn"><a href="#" style="text-decoration:none; color:#565656;">Listings</a></button>
 </div>
 <div class="dropdown">
 ...
 <div class="dropdown">
  ...
  <div class="dropdown-content">
   ...
   <div class="dropdown">
  <button class="dropbtn">Cpanel</button>
  <div class="dropdown-content">
  <li> <a href="vendor.php">Vendor Page</a></li>
   <li> <a href="add-product.php">Add Products</a></li>
   <li> <a href="products.php">View All Products</a></li>
   <li> <a href="categories.php">View Categories</a></li>
   <li> <a href="add-category.php">Add Category</a></li>
   <li> <a href="category.php">Edit/Delete Categories</a></li>
  </div>
  </div>
 
  <h2 style="display:inline-block; margin-left:20px;">REUP MARKET</h2>
 <div class="dropdown" style="margin-left:40px;">
  <button class="dropbtn"><a href="#" style="text-decoration:none; color:black;">Become A Merchant</a></button>
 </div>
    </div>
    <div style=" color: #010204;
              top: 0px;
              position: absolute;
    ...
    <li style="display:inline-block;">
          <a href="cart.php"><i class="fa-sharp fa-regular fa-cart-shopping">
                <img src="../phpecom/images/shopping-cart.png"><span id="cartItemsQuantityCount">0</span></i></a>
                <div class="dropdown" style="margin-left:40px;"> </li>
                <div class="dropdown">
